  ...
  return (
    <section className="ml-section ml-hero">
      <MLReveal>
        ...
        <h1 className="ml-h1">
          Tired of applying on LinkedIn? Send your application directly to the hiring team & land more interviews.
        </h1>
        <p className="ml-lead">
          ToInbox finds the relevant department head and recruiter behind any LinkedIn job and sends your personalised job application straight to their mail boxes — get noticed, get replies.
        </p>
      ...
      <div className="ml-price-stack">
        <MLReveal style={{ transitionDelay: '60ms' }}>
          <div className="ml-price-card">
            ...
            <div className="ml-price-feats">
              {['6 personalized sends', '3 follow-up credits', 'Dashboard + Analytics'].map((f) => (
        ...
        <MLReveal style={{ transitionDelay: '120ms' }}>
          <div className="ml-price-card ml-featured">
            ...
            <div className="ml-price-feats">
              {['50 personalized sends', '25 follow-up credits', 'Dashboard + Analytics'].map((f) => (
                <div className="ml-price-feat" key={f}><span className="ml-price-check"><Icon name="check" size={10} /></span>{f}</div>
              ))}
            </div>
        ...
        <MLReveal style={{ transitionDelay: '180ms' }}>
          <div className="ml-price-card">
            ...
            <div className="ml-price-feats">
              {['100 personalized sends', '60 follow-up credits', 'Dashboard + Analytics', 'Best for an active search'].map((f) => (
                <div className="ml-price-feat" key={f}><span className="ml-price-check"><Icon name="check" size={10} /></span>{f}</div>
              ))}
            </div>
    ...
    <section className="ml-section">
      <MLReveal>
        <div className="ml-final">
          ...
          <div className="ml-final-note">NO CARD REQUIRED · 6 FREE CREDITS · WORKS ON LINKEDIN</div>
        </div>
      </MLReveal>
    </section>
  );
