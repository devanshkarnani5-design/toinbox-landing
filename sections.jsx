        ...
        <div className="pricing-grid" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
          ...
          <div className="price-card featured" data-reveal style={{ transitionDelay: '90ms' }}>
            ...
            <div>
              ...
              <div className="price-sub">40 credits · valid 40 days</div>
            </div>
            <div className="price-feats">
          ...
          <div className="price-card" data-reveal style={{ transitionDelay: '180ms' }}>
            <div>
              ...
              <div className="price-sub">80 credits · valid 60 days</div>
            </div>
            <div className="price-feats">
    ...
    <section className="section">
      <div className="wrap">
        <div className="final-cta" data-reveal>
          ...
          <div style={{ marginTop: 36, fontSize: 12.5, color: 'rgba(255,255,255,0.5)', fontFamily: 'var(--font-mono)' }}>NO CARD REQUIRED · WORKS ON LINKEDIN</div>
        </div>
      </div>
    </section>
  );
